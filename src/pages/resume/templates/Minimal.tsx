...
const Minimal: React.FC<MinimalProps> = ({ formData }) => {
  ...
  return (
    <div className="font-sans text-gray-900 p-8 bg-card shadow-lg min-h-full">
      ...
      <div className="mb-6 pb-4 border-b border-primary">
        ...
        <div className="flex flex-wrap items-center text-xs text-gray-900 gap-x-3 gap-y-1">
      ...
      {experience.length > 0 && (
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-2 border-b border-primary pb-1">
            EXPERIENCE
          </h2>
          {experience.map((exp, index) => (
            <div key={index} className="mb-3">
              ...
              <p className="text-xs text-gray-900 mb-1">{exp.location}</p>
              <ul className="list-disc list-inside text-xs text-gray-900 space-y-0.5">
      ...
      {skills.length > 0 && (
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-1 text-xs text-gray-900">
