...
const Creative: React.FC<CreativeProps> = ({ formData }) => {
  const { personalInformation, experience, education, skills, projects, certifications, leadership, research } =
    formData;

  return (
    <div className="font-sans text-gray-900 p-8 bg-card shadow-lg min-h-full grid grid-cols-3 gap-8">
      ...
      <div className="col-span-2 space-y-8">
        ...
        {experience.length > 0 && (
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-3 border-b border-primary pb-1">
              EXPERIENCE
            </h2>
