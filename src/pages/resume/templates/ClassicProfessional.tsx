...
const ClassicProfessional: React.FC<ClassicProfessionalProps> = ({ formData }) => {
    ...
    <div className="font-sans text-gray-900 p-8 bg-card shadow-lg min-h-full">
      ...
      <div className="text-center mb-6 pb-4 border-b border-primary">
        ...
        <p className="text-sm text-gray-900 mb-2">
          {personalInformation.location} | P: {personalInformation.phone} | {personalInformation.email}
        </p>
        <div className="flex flex-wrap justify-center items-center text-sm text-gray-900 gap-x-4 gap-y-1">
      ...
      {/* Research (if not already included in projects) */}
      {research.length > 0 && (
        <div className="mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-3 border-b border-primary pb-1">
            RESEARCH
