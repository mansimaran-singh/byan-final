...
const Professional: React.FC<ProfessionalProps> = ({ formData }) => {
  const { personalInformation, experience, education, skills, projects, certifications, leadership, research } =
    formData;

  return (
    <div className="font-sans text-gray-900 p-10 bg-card shadow-lg min-h-full">
      {/* Personal Information */}
      <div className="mb-8 pb-4 border-b-2 border-primary">
        <h1 className="text-4xl font-bold text-gray-900 mb-2 tracking-wide text-center">
          {personalInformation.fullName}
        </h1>
        <p className="text-md text-gray-900 mb-4 text-center">
